...
class CallOptionsTest : StringSpec({
    ...
    "create preview to buy call option limit" {
        val path = Paths.get("brokers/etrade/orders/createPreview/callOptions/buy_limit.json")
    ...
    "create preview to sell call option limit" {
        val path = Paths.get("brokers/etrade/orders/createPreview/callOptions/sell_limit.json")
    ...
    "create preview to buy call option market" {
        val path = Paths.get("brokers/etrade/orders/createPreview/callOptions/buy_market.json")
    ...
    "create preview to sell call option market" {
        val path = Paths.get("brokers/etrade/orders/createPreview/callOptions/sell_market.json")
