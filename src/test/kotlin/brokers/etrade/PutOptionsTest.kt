...
class PutOptionsTest : StringSpec({
    ...
    "create preview to buy put option limit" {
        val path = Paths.get("brokers/etrade/orders/createPreview/putOptions/buy_limit.json")
    ...
    "create preview to sell put option limit" {
        val path = Paths.get("brokers/etrade/orders/createPreview/putOptions/sell_limit.json")
    ...
    "create preview to buy call option market" {
        val path = Paths.get("brokers/etrade/orders/createPreview/putOptions/buy_market.json")
    ...
    "create preview to sell put option market" {
        val path = Paths.get("brokers/etrade/orders/createPreview/putOptions/sell_market.json")
